...
public class GlobalConfigMgr {
    ...
    public void init() {
        ...
        try {
            ...
            int slice_time = Integer.decode(properties.getProperty(SLICE_TIME, "15"));
    ...
    public static String MULTI_BLOOM_FILTER_NUMBER = "multi_bloom_filter_number";
    public static String BLOOM_FILTER_LENGTH = "bloom_filter_length";
    public static String MONITOR_ADDRESS = "monitor_address";
    public static String HOTSPOT_THRESHOLD = "hotspot_threshold";
    public static String SLICE_TIME = "slice_time";
    public static String FREQUENT_ITEM_NUMBER = "frequent_item_number";
}
